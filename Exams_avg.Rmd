...
for (r in 1:10) {
  ...
  correct_list <- c()
  not_list <-c()
  while (num_of_exams <= 35) {
    if (test == 1) {
    num_of_exams <- num_of_exams + 1
    }
...
while (falsely_accused == 0) {
  ...
  exam_list <- c(exam_list, num_of_exams)
...
matplot(exam_list, cbind(correctly_identified_average, unidentified_average), type="l", lty = 1, col=c("green", "blue"), 
        xlab = "Number of Exams Taken", ylab = "Number of Students", main = "Relationship between Number of Exams Taken \nand Model Performance at ''Optimal'' Lambda")
legend("topright", legend = c("Correctly Identified Cheaters", "Undetected Cheaters"),
       col = c("green", "blue"), lty = 1)

matplot(exam_list, cbind(lambda_average), type="l", lty = 1, col="black", xlab = "Number of Exams Taken", ylab = "Lambda", main = "Relationship between ''Optimal'' Lambda \nand Number of Exams Taken")
